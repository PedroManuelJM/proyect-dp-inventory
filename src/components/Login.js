...
if (result === -2) {
      ...
      return Swal.fire({
          title: `El usuario no existe o la contraseña es incorrecta`,
  ...
  localStorage.setItem("DatosUsuario", JSON.stringify(result)) //sringify convierte en string el valor
  navigate('/')

  Swal.fire({
      title: `Bienvenido: ${result.nombres}`,
      text: '',
      timer: 2000,
      icon: "success",
      timerProgressBar: true,
            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-md-4">
                        ...
                        </svg><span style={{ color: "black", maxWidth: "64px",fontSize:"22px" }}> &nbsp; Inventario Despacho Presidencial  </span>
